...
define(["text!temple/software/index.html", "css!temple/software/index.css", "vue", "component/gl-input/index", "component/gl-btn/index", "component/gl-tooltip/index", "component/gl-loading/index", 'component/pagination/index', 'component/modal/modal', "component/gl-select/index", "component/dropdown/index"], function (stpl, css, Vue, gl_input, gl_btn, gl_tooltip, gl_loading, gl_pagination, gl_modal, gl_select, gl_dropdown) {
    var vueComponent = Vue.extend({
        ...
        beforeRouteLeave: function beforeRouteLeave(to, from, next) {
            if (!this.currentStatus || this.serchDis) {
                this.$message({
                    type: 'warning',
                    msg: -1900
                });
        ...
        computed: {
            ...
            //     return this.$store.getters.apiData["updatesofeware"];
            // },
        ...
        methods: {
            ...
            getAllSorftWare: function getAllSorftWare() {
                var that = this;
                that.currentStatus = false; //  软件列表加载状态
            ...
            updateSortWare: function updateSortWare() {
                ...
                // }
                // if (storage) {
                //     storage.removeItem("sorftware");
                // }
                // var timeNow = new Date();
                // var sorftwarelist = null;
                // if (storage) {
                //     sorftwarelist = JSON.parse(storage.getItem("sorftware"));
                // }
                // var noupdate = false;
                // if (sorftwarelist) {
                //     var data = JSON.parse(sorftwarelist.data);
                //     if (data.count > 1000 && timeNow - sorftwarelist.time <= sorftwarelist.timeout) {
                //         noupdate = true;
                //     } else {
                //         storage.removeItem("sorftware");
                //     }
                // }
                // noupdate ? that.getAllSorftWare() :
