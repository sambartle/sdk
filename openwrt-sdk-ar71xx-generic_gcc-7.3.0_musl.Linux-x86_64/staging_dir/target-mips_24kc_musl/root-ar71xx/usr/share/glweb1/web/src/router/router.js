...
define(["vue", "vueRouter", "require"], function (Vue, vueRouter, require) {
    ...
    var router = new vueRouter({ routes: [{ path: "", redirect: "internet" }, {
            ...
            name: "applications",
            component: function component(resolve) {
                require(["/src/temple/applications/index.js"], resolve);
            }
        }, {
            path: "/attools",
            name: "attools",
            ...
            name: "moresetting",
            component: function component(resolve) {
                require(["/src/temple/moresetting/index.js"], resolve);
            }
        }, {
            path: "/process",
            name: "process",
            ...
            name: "system",
            component: function component(resolve) {
                require(["/src/temple/system/index.js"], resolve);
            }
        }, {
            path: "/timezone",
            name: "timezone",
            ...
            name: "vpn",
            component: function component(resolve) {
                require(["/src/temple/vpn/index.js"], resolve);
            }
        }, {
            path: "/vpnclient",
            name: "vpnclient",
