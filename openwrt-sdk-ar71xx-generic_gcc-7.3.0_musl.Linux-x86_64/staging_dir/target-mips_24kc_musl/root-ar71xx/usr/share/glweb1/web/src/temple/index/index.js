    ...
    var vueComponent = Vue.extend({
        ...
        data: function data() {
            return {
                ...
                routers: ["applications", "system", "moresetting", "vpn"],
        ...
        computed: {
            ...
            wifiNum: function wifiNum() {
                return this.router.wifi_cli_count != 0 && this.router.hasOwnProperty('wifi_cli_count') ? this.router.wifi_cli_count : 0;
            },
            // 通过lan口连接的设备数量
            ...
            phoneInter: function phoneInter() {
                if (this.router.model == 'usb150') {
                    ...
                    if (this.wifiIconActive || this.waninfo.ip || this.teinfo.ip || this.moStatus.up) {
                        return true;
                    } else {
                        return false;
                    }
            ...
            settings: function settings() {
                return this.router.has_sw && this.routermode == 'router' && this.router.model != 'vixmini' && this.router.model != 'usb150' && this.router.model != 'x750-4g';
            },
        ...
        beforeCreate: function beforeCreate() {
            ...
            this.$store.dispatch("setALLtimer"); // 全局一直调用定时器
        },
        methods: {
